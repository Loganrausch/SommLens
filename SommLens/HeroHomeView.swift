...
struct HeroHomeView: View {
    ...
    @State private var showDash = false     // controls sheet
            ...
            VStack {
                ...
                // 1️⃣ Top title
                               Text("SommLens")
                                   ...
                                   .padding(.top, 50)             // keep it clear of the notch
                ...
                // MARK: – Dashboard trigger (capsule)
                Button {
                    showDash = true
                } label: {
                    HStack(spacing: 6) {
                ...
                .padding(.bottom, 50)   // keep your original bottom spacing
            }
            .frame(maxWidth: .infinity, maxHeight: .infinity) // takes full screen height
        }
        .onAppear { pulse = true }
